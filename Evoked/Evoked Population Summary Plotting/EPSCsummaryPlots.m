...
% Hzs = {'x1', 'Hz20'};
% displayHzs = {'Single Stim','20 Hz','40 Hz'};
...
GUI_selectPlots % GUI with checkboxes to choose drugs
...
Datasum(numConds, pharm1, varargin) %use varargin if there is a pharm2
